...
class Data:
    ...
    def node_to_essential_items(self):
        ...
        if self._node_to_essential_items is None:
            self._node_to_essential_items = pd.read_pickle(self.dir + 'occupation_to_essential_skills.pickle')
    ...
    def node_to_all_items(self):
        ...
        if self._node_to_all_items is None:
            self._node_to_all_items = pd.read_pickle(self.dir + 'occupation_to_all_skills.pickle')
