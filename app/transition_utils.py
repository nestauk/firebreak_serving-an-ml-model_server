...
import compare_nodes_utils as compare_nodes_utils
...
embeddings = np.load('./interim/embeddings/embeddings_skills_description_SBERT.npy')

### SET UP DEFAULT TRANSITION FILTERING CRITERIA ###

this_file_path = os.path.dirname(os.path.realpath(__file__))
with open(f'{this_file_path}/configs/default_transition_params.yaml', 'r') as f:
...
class Upskilling():
    ...
    def __init__(self,
        ...
        activity_vector_dir = './interim/work_activity_features/'
        ...
        esco_to_work_context_vector = pd.read_csv('./interim/work_context_features/occupations_work_context_vector.csv')
        ...
        with open(f'{this_file_path}/configs/default_combined_similarity_params.yaml', 'r') as f:
    ...
    def dump_results(self, filename='upskilling_results.pickle', dir=f'{this_file_path}/interim/upskilling_analysis/'):
        """
